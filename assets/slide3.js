  ...
  render() {
    ...
    const nextbutton = {
      ...
      const el2 = {
          ...
          fontWeight: "bold",
          fontSize: "0.5em",
          position: "fixed; left: 200px; top: -80px",
          overflow: "hidden",
          visibility: "hidden"
      }
...
/*      if (this.state.count == 0) {
    ...
    return (
        <div ref="d1" onKeyDown={this.add} >
            ...
            <div id="r1" data-spk="Metre uses m. as an abbreviation" style={el1}>
            ...
            <div id="btm" data-spk="Meter uses em, as an abbreviation" style={slidebottom}>
                Metre uses m. as an abbreviation.
            </div>
        </div>
    );
