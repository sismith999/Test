...
import imgMeterStickZoomCm from './meterstickZoomCm.png';
  ...
  render() {
    ...
    const nextbutton = {
      ...
      const el2 = {
          ...
          fontWeight: "bold",
          fontSize: "0.5em",
          position: "fixed; left: 240px; top: 100px",
          overflow: "hidden",
          visibility: "hidden"
      }
        ...
        <div ref="d1" onKeyDown={this.add} >
            ...
            <div id="r1" style={el1}>
                <div id="r1_text" style={inlineBlocktext} >Meter Stick&nbsp;&nbsp;&nbsp;&nbsp;
                    <img id="r1_image" style={meterstick} src={imgMeterStickZoomCm} ></img>
                </div>
            </div>
            ...
            <div id="btm" data-spk="Centimeter uses see,em, as an abbreviation" style={slidebottom}>
                Centimetre uses cm. as an abbreviation.
            </div>
        </div>
    );
